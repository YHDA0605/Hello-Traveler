	...
	<div class="container myPage">
		...
		<div class="myPageBody">
        	...
        	<div class="myPageBodyCont">
          		<div class="myInfo">
          			<div class="myPageContfield">
						<label>이름</label><input type="text" value="${mbr.mem_name }" readonly/>
              		</div>
              		<br />
              		<form action="editNick" method="post" class="myPageContfield">
              			<label>닉네임</label><input type="text" name="mem_nick" value="${mbr.mem_nick }" readonly style="margin-bottom:0px;"/>
              			<button type="button" class="editNickChange edit">수정</button>
              			<button type="button" class="nickCheck noShowBtn noEdit">중복확인</button>
              			<button type="submit" class="confirmNickChange noShowBtn noEdit">확인</button>
              			<div class="myPageNickChkResult"></div>
              		</form>
              		
              		<br />
              		<form action="editPhone" method="post" class="myPageContfield">
              			<label>TEL</label><input type="text" name="mem_phone" value="${mbr.mem_phone }" readonly/>
              			<button type="button" class="editPhoneChange edit">수정</button>
              			<button type="submit" class="confirmPhoneChange noShowBtn noEdit">확인</button>
              		</form>
              		<br />
              		<form action="editEmail" method="post" class="myPageContfield">
              			<label>EMAIL</label><input type="text" name="mem_email" value="${mbr.mem_email }" readonly/>
              			<button type="button" class="editEmailChange edit">수정</button>
              			<button type="submit" class="confirmEmailChange noShowBtn noEdit">확인</button>
              		</form>
          		</div>
			</div>
		</div>
